...
CSpecimen::CSpecimen(CWnd *pParent) : CDialog(CSpecimen::IDD, pParent)
{
...
void CSpecimen::OnBUTTONSave()
{
    ...
    if (SpcSaveFile_dlg.DoModal() == IDOK)
    {
        ...
        {
            fprintf(FileSpcData, "%s    %lf    %lf    %lf    %lf\n", "Diameter(mm)", SpecimenData->Diameter[0],
                    SpecimenData->Diameter[1], SpecimenData->Diameter[2], SpecimenData->Diameter[3]);
            fprintf(FileSpcData, "%s    %lf    %lf    %lf    %lf\n", "Width(mm)", SpecimenData->Width[0],
                    SpecimenData->Width[1], SpecimenData->Width[2], SpecimenData->Width[3]);
            fprintf(FileSpcData, "%s    %lf    %lf    %lf    %lf\n", "Depth(mm)", SpecimenData->Depth[0],
                    SpecimenData->Depth[1], SpecimenData->Depth[2], SpecimenData->Depth[3]);
            fprintf(FileSpcData, "%s    %lf    %lf    %lf    %lf\n", "Height(mm)", SpecimenData->Height[0],
                    SpecimenData->Height[1], SpecimenData->Height[2], SpecimenData->Height[3]);
            fprintf(FileSpcData, "%s    %lf    %lf    %lf    %lf\n", "Area(mm^2)", SpecimenData->Area[0],
                    SpecimenData->Area[1], SpecimenData->Area[2], SpecimenData->Area[3]);
            fprintf(FileSpcData, "%s    %lf    %lf    %lf    %lf\n", "Volume(mm^3)", SpecimenData->Volume[0],
                    SpecimenData->Volume[1], SpecimenData->Volume[2], SpecimenData->Volume[3]);
            fprintf(FileSpcData, "%s    %lf    %lf    %lf    %lf\n", "Weight(g)", SpecimenData->Weight[0],
                    SpecimenData->Weight[1], SpecimenData->Weight[2], SpecimenData->Weight[3]);
            fprintf(FileSpcData, "%s    %lf    %lf    %lf    %lf\n", "VLDT1(mm)", SpecimenData->VLDT1[0],
                    SpecimenData->VLDT1[1], SpecimenData->VLDT1[2], SpecimenData->VLDT1[3]);
            fprintf(FileSpcData, "%s    %lf    %lf    %lf    %lf\n", "VLDT2(mm)", SpecimenData->VLDT2[0],
                    SpecimenData->VLDT2[1], SpecimenData->VLDT2[2], SpecimenData->VLDT2[3]);
