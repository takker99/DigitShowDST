...
void CCalibrationFactor::CF_Load()
{
	...
	if(m_Channels=="CH0-CH15"){	
		m_CFA00=ctx->cal.a[0];	m_CFB00=ctx->cal.b[0];	m_CFC00=ctx->cal.c[0];	m_CFP00.Format("%11.5f",ctx->Phyout[0]);	
		m_CFA01=ctx->cal.a[1];	m_CFB01=ctx->cal.b[1];	m_CFC01=ctx->cal.c[1];	m_CFP01.Format("%11.5f",ctx->Phyout[1]);	
		m_CFA02=ctx->cal.a[2];	m_CFB02=ctx->cal.b[2];	m_CFC02=ctx->cal.c[2];	m_CFP02.Format("%11.5f",ctx->Phyout[2]);	
		m_CFA03=ctx->cal.a[3];	m_CFB03=ctx->cal.b[3];	m_CFC03=ctx->cal.c[3];	m_CFP03.Format("%11.5f",ctx->Phyout[3]);	
		m_CFA04=ctx->cal.a[4];	m_CFB04=ctx->cal.b[4];	m_CFC04=ctx->cal.c[4];	m_CFP04.Format("%11.5f",ctx->Phyout[4]);	
		m_CFA05=ctx->cal.a[5];	m_CFB05=ctx->cal.b[5];	m_CFC05=ctx->cal.c[5];	m_CFP05.Format("%11.5f",ctx->Phyout[5]);	
		m_CFA06=ctx->cal.a[6];	m_CFB06=ctx->cal.b[6];	m_CFC06=ctx->cal.c[6];	m_CFP06.Format("%11.5f",ctx->Phyout[6]);	
		m_CFA07=ctx->cal.a[7];	m_CFB07=ctx->cal.b[7];	m_CFC07=ctx->cal.c[7];	m_CFP07.Format("%11.5f",ctx->Phyout[7]);	
		m_CFA08=ctx->cal.a[8];	m_CFB08=ctx->cal.b[8];	m_CFC08=ctx->cal.c[8];	m_CFP08.Format("%11.5f",ctx->Phyout[8]);	
		m_CFA09=ctx->cal.a[9];	m_CFB09=ctx->cal.b[9];	m_CFC09=ctx->cal.c[9];	m_CFP09.Format("%11.5f",ctx->Phyout[9]);	
		m_CFA10=ctx->cal.a[10];	m_CFB10=ctx->cal.b[10];	m_CFC10=ctx->cal.c[10];	m_CFP10.Format("%11.5f",ctx->Phyout[10]);	
		m_CFA11=ctx->cal.a[11];	m_CFB11=ctx->cal.b[11];	m_CFC11=ctx->cal.c[11];	m_CFP11.Format("%11.5f",ctx->Phyout[11]);	
		m_CFA12=ctx->cal.a[12];	m_CFB12=ctx->cal.b[12];	m_CFC12=ctx->cal.c[12];	m_CFP12.Format("%11.5f",ctx->Phyout[12]);	
		m_CFA13=ctx->cal.a[13];	m_CFB13=ctx->cal.b[13];	m_CFC13=ctx->cal.c[13];	m_CFP13.Format("%11.5f",ctx->Phyout[13]);	
		m_CFA14=ctx->cal.a[14];	m_CFB14=ctx->cal.b[14];	m_CFC14=ctx->cal.c[14];	m_CFP14.Format("%11.5f",ctx->Phyout[14]);	
		m_CFA15=ctx->cal.a[15];	m_CFB15=ctx->cal.b[15];	m_CFC15=ctx->cal.c[15];	m_CFP15.Format("%11.5f",ctx->Phyout[15]);	
	...
	if(m_Channels=="CH16-CH31"){	
		m_CFA00=ctx->cal.a[16];	m_CFB00=ctx->cal.b[16];	m_CFC00=ctx->cal.c[16];	m_CFP00.Format("%11.5f",ctx->Phyout[16]);	
		m_CFA01=ctx->cal.a[17];	m_CFB01=ctx->cal.b[17];	m_CFC01=ctx->cal.c[17];	m_CFP01.Format("%11.5f",ctx->Phyout[17]);	
		m_CFA02=ctx->cal.a[18];	m_CFB02=ctx->cal.b[18];	m_CFC02=ctx->cal.c[18];	m_CFP02.Format("%11.5f",ctx->Phyout[18]);	
		m_CFA03=ctx->cal.a[19];	m_CFB03=ctx->cal.b[19];	m_CFC03=ctx->cal.c[19];	m_CFP03.Format("%11.5f",ctx->Phyout[19]);	
		m_CFA04=ctx->cal.a[20];	m_CFB04=ctx->cal.b[20];	m_CFC04=ctx->cal.c[20];	m_CFP04.Format("%11.5f",ctx->Phyout[20]);	
		m_CFA05=ctx->cal.a[21];	m_CFB05=ctx->cal.b[21];	m_CFC05=ctx->cal.c[21];	m_CFP05.Format("%11.5f",ctx->Phyout[21]);	
		m_CFA06=ctx->cal.a[22];	m_CFB06=ctx->cal.b[22];	m_CFC06=ctx->cal.c[22];	m_CFP06.Format("%11.5f",ctx->Phyout[22]);	
		m_CFA07=ctx->cal.a[23];	m_CFB07=ctx->cal.b[23];	m_CFC07=ctx->cal.c[23];	m_CFP07.Format("%11.5f",ctx->Phyout[23]);	
		m_CFA08=ctx->cal.a[24];	m_CFB08=ctx->cal.b[24];	m_CFC08=ctx->cal.c[24];	m_CFP08.Format("%11.5f",ctx->Phyout[24]);	
		m_CFA09=ctx->cal.a[25];	m_CFB09=ctx->cal.b[25];	m_CFC09=ctx->cal.c[25];	m_CFP09.Format("%11.5f",ctx->Phyout[25]);	
		m_CFA10=ctx->cal.a[26];	m_CFB10=ctx->cal.b[26];	m_CFC10=ctx->cal.c[26];	m_CFP10.Format("%11.5f",ctx->Phyout[26]);	
		m_CFA11=ctx->cal.a[27];	m_CFB11=ctx->cal.b[27];	m_CFC11=ctx->cal.c[27];	m_CFP11.Format("%11.5f",ctx->Phyout[27]);	
		m_CFA12=ctx->cal.a[28];	m_CFB12=ctx->cal.b[28];	m_CFC12=ctx->cal.c[28];	m_CFP12.Format("%11.5f",ctx->Phyout[28]);	
		m_CFA13=ctx->cal.a[29];	m_CFB13=ctx->cal.b[29];	m_CFC13=ctx->cal.c[29];	m_CFP13.Format("%11.5f",ctx->Phyout[29]);	
		m_CFA14=ctx->cal.a[30];	m_CFB14=ctx->cal.b[30];	m_CFC14=ctx->cal.c[30];	m_CFP14.Format("%11.5f",ctx->Phyout[30]);	
		m_CFA15=ctx->cal.a[31];	m_CFB15=ctx->cal.b[31];	m_CFC15=ctx->cal.c[31];	m_CFP15.Format("%11.5f",ctx->Phyout[31]);	
...
void CCalibrationFactor::OnBUTTONCFUpdate() 
{
	...
	UpdateData(TRUE);
	if(m_Channels=="CH0-CH15"){	
		ctx->cal.a[0]=m_CFA00;	ctx->cal.b[0]=m_CFB00;	ctx->cal.c[0]=m_CFC00;	
		ctx->cal.a[1]=m_CFA01;	ctx->cal.b[1]=m_CFB01;	ctx->cal.c[1]=m_CFC01;	
		ctx->cal.a[2]=m_CFA02;	ctx->cal.b[2]=m_CFB02;	ctx->cal.c[2]=m_CFC02;	
		ctx->cal.a[3]=m_CFA03;	ctx->cal.b[3]=m_CFB03;	ctx->cal.c[3]=m_CFC03;	
		ctx->cal.a[4]=m_CFA04;	ctx->cal.b[4]=m_CFB04;	ctx->cal.c[4]=m_CFC04;	
		ctx->cal.a[5]=m_CFA05;	ctx->cal.b[5]=m_CFB05;	ctx->cal.c[5]=m_CFC05;	
		ctx->cal.a[6]=m_CFA06;	ctx->cal.b[6]=m_CFB06;	ctx->cal.c[6]=m_CFC06;	
		ctx->cal.a[7]=m_CFA07;	ctx->cal.b[7]=m_CFB07;	ctx->cal.c[7]=m_CFC07;	
		ctx->cal.a[8]=m_CFA08;	ctx->cal.b[8]=m_CFB08;	ctx->cal.c[8]=m_CFC08;	
		ctx->cal.a[9]=m_CFA09;	ctx->cal.b[9]=m_CFB09;	ctx->cal.c[9]=m_CFC09;	
		ctx->cal.a[10]=m_CFA10;	ctx->cal.b[10]=m_CFB10;	ctx->cal.c[10]=m_CFC10;	
		ctx->cal.a[11]=m_CFA11;	ctx->cal.b[11]=m_CFB11;	ctx->cal.c[11]=m_CFC11;	
		ctx->cal.a[12]=m_CFA12;	ctx->cal.b[12]=m_CFB12;	ctx->cal.c[12]=m_CFC12;	
		ctx->cal.a[13]=m_CFA13;	ctx->cal.b[13]=m_CFB13;	ctx->cal.c[13]=m_CFC13;	
		ctx->cal.a[14]=m_CFA14;	ctx->cal.b[14]=m_CFB14;	ctx->cal.c[14]=m_CFC14;	
		ctx->cal.a[15]=m_CFA15;	ctx->cal.b[15]=m_CFB15;	ctx->cal.c[15]=m_CFC15;	
	}
	if(m_Channels=="CH16-CH31"){	
		ctx->cal.a[16]=m_CFA00;	ctx->cal.b[16]=m_CFB00;	ctx->cal.c[16]=m_CFC00;	
		ctx->cal.a[17]=m_CFA01;	ctx->cal.b[17]=m_CFB01;	ctx->cal.c[17]=m_CFC01;	
		ctx->cal.a[18]=m_CFA02;	ctx->cal.b[18]=m_CFB02;	ctx->cal.c[18]=m_CFC02;	
		ctx->cal.a[19]=m_CFA03;	ctx->cal.b[19]=m_CFB03;	ctx->cal.c[19]=m_CFC03;	
		ctx->cal.a[20]=m_CFA04;	ctx->cal.b[20]=m_CFB04;	ctx->cal.c[20]=m_CFC04;	
		ctx->cal.a[21]=m_CFA05;	ctx->cal.b[21]=m_CFB05;	ctx->cal.c[21]=m_CFC05;	
		ctx->cal.a[22]=m_CFA06;	ctx->cal.b[22]=m_CFB06;	ctx->cal.c[22]=m_CFC06;	
		ctx->cal.a[23]=m_CFA07;	ctx->cal.b[23]=m_CFB07;	ctx->cal.c[23]=m_CFC07;	
		ctx->cal.a[24]=m_CFA08;	ctx->cal.b[24]=m_CFB08;	ctx->cal.c[24]=m_CFC08;	
		ctx->cal.a[25]=m_CFA09;	ctx->cal.b[25]=m_CFB09;	ctx->cal.c[25]=m_CFC09;	
		ctx->cal.a[26]=m_CFA10;	ctx->cal.b[26]=m_CFB10;	ctx->cal.c[26]=m_CFC10;	
		ctx->cal.a[27]=m_CFA11;	ctx->cal.b[27]=m_CFB11;	ctx->cal.c[27]=m_CFC11;	
		ctx->cal.a[28]=m_CFA12;	ctx->cal.b[28]=m_CFB12;	ctx->cal.c[28]=m_CFC12;	
		ctx->cal.a[29]=m_CFA13;	ctx->cal.b[29]=m_CFB13;	ctx->cal.c[29]=m_CFC13;	
		ctx->cal.a[30]=m_CFA14;	ctx->cal.b[30]=m_CFB14;	ctx->cal.c[30]=m_CFC14;	
		ctx->cal.a[31]=m_CFA15;	ctx->cal.b[31]=m_CFB15;	ctx->cal.c[31]=m_CFC15;
	}
}
...
void CCalibrationFactor::OnBUTTONCFLoadFile() 
{
	...
	//	FileCalData = fopen((LPCSTR)pFileName , "r" );
		if((err = fopen_s(&FileCalData,(LPCSTR)pFileName , _T("r"))) == 0)
		{
			...
			for(i=0;i<64;i++){
				//fscanf(FileCalData,"%d%lf%lf%lf",&j,&ctx->cal.a[i],&ctx->cal.b[i],&ctx->cal.c[i]);
